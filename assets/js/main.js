(function ($) {
    ...
    $('.portfolio-content-wrapper').slick({
        ...
        speed: 2000,
        prevArrow: '<button type="button" class="slick-prev"> <img src="assets/images/arrow-right-white.png" alt="arrow"></button>',
        nextArrow: '<button type="button" class="slick-next"> <img src="assets/images/arrow-right-white.png" alt="arrow"></button>',
        pauseOnHover:true,
    });
    $('.portfolio-img').slick({
        slidesToShow: 1,
